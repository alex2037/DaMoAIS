...
| Промежуточное тестирование | Экспресс-тесты в начале лекции по пройденному материалу | [ЛР-тесты модулей](#3-контрольно-измерительные-материалы) | 15 |
| Лабораторные работы | Сдача лабораторных работ ЛР1–ЛР7 по модулям | [КИМ модулей M1–M7](#3-контрольно-измерительные-материалы) | 30 |
| Peer-review | Рецензирование работ сокурсников: участие + качество рецензий | [Регламент peer-review](methodical-guidelines/teachers-assessment/README.md) | 10 |
| Командный проект | Подготовка и защита командного проекта (2 оси: «Программное решение» и «Документация») | [Проектная работа](Project/README.md) | 20 |
| Зачёт | Устный ответ на вопросы по дисциплине с примерами; практическое задание с оценкой существующих решений | [Зачёт](Credit/README.md) | 25 |
| **Итого** | | | **100** |
...
Каждое оценочное средство использует единую 10-балльную рубрику с опорными точками уровней КРМ (4 — Б, 6 — С, 8 — С–П, 10 — П); соответствие 10-балльной шкалы весам в 100 баллов выполняется пропорционально. Триангуляция обеспечена: каждый индикатор КРМ проверяется не менее чем двумя средствами (см. [модель измерения](#2-модель-измерения)).
...
Предлагаемая лицензия для открытых образовательных материалов — **Creative Commons Attribution 4.0 International (CC BY 4.0)**. Перед публикацией согласуйте выбор лицензии с правообладателем; текст лицензии — в файле [LICENSE](LICENSE).
